...
ResultSet rs;
  try{
    ...
    if(id ==null){
      out.print("<script type=\"text/javascript\">alert(\"請從view選取修改\");</script>");
      message = "3";//ID爲空
...
$('#d option[value="<%=day%>"]').attr('selected', true);
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">ID : </th>
			<td><input type="text" value="<%=id%>" class="inp-form" disabled="disabled" id="id"/></td>
			<td>
  			<div class="error-left"></div>
  			<div class="error-inner">Can't modify.</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" value="<%=password%>" class="inp-form" id="password"/></td>
			<td></td>
		</tr>
		<tr>
		<th valign="top">Name:</th>
		<td><input type="text" value="<%=name%>" class="inp-form" id="name" /></td>
		<td></td>
		</tr>
		<tr>
	...
	<tr>
	<th>Registry time :</th>
	<td>  <input type="text" value="<%=time%>" class="inp-form" disabled="disabled"/></td>
	<td>
      <div class="error-left"></div>
      <div class="error-inner">Can't modify.</div>
	</td>
