...
ResultSet rs;
  try{
    ...
    while(rs.next()){
      ...
      sqlresult += "<td><input type=\"checkbox\" value=\""+rs.getString("id")+"\"/></td>";
      sqlresult += "<td>"+rs.getString("id")+"</td><td>"+rs.getString("account")+"</td><td>"+rs.getString("name")+"</td><td>"+rs.getString("birth")+"</td>";
